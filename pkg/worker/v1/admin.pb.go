...
const file_worker_v1_admin_proto_rawDesc = "" +
	...
	"\x06paused\x18\x06 \x01(\bR\x06paused\"\x16\n" +
	...
	"\x05moved\x18\x01 \x01(\x05R\x05moved2\x8d\b\n" +
	"\fAdminService\x12F\n" +
	...
	"\rReplayDLQByID\x12\x1f.worker.v1.ReplayDLQByIDRequest\x1a .worker.v1.ReplayDLQByIDResponseB4Z2github.com/hyp3rd/go-worker/pkg/worker/v1;workerpbb\x06proto3"
...
var (
	file_worker_v1_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
	file_worker_v1_admin_proto_goTypes  = []any{
		...
		(*ScheduleEntry)(nil),          // 12: worker.v1.ScheduleEntry
		(*ListSchedulesRequest)(nil),   // 13: worker.v1.ListSchedulesRequest
		(*ListSchedulesResponse)(nil),  // 14: worker.v1.ListSchedulesResponse
		(*CreateScheduleRequest)(nil),  // 15: worker.v1.CreateScheduleRequest
		(*CreateScheduleResponse)(nil), // 16: worker.v1.CreateScheduleResponse
		(*DeleteScheduleRequest)(nil),  // 17: worker.v1.DeleteScheduleRequest
		(*DeleteScheduleResponse)(nil), // 18: worker.v1.DeleteScheduleResponse
		(*PauseScheduleRequest)(nil),   // 19: worker.v1.PauseScheduleRequest
		(*PauseScheduleResponse)(nil),  // 20: worker.v1.PauseScheduleResponse
		(*DLQEntry)(nil),               // 21: worker.v1.DLQEntry
		(*ListDLQRequest)(nil),         // 22: worker.v1.ListDLQRequest
		(*ListDLQResponse)(nil),        // 23: worker.v1.ListDLQResponse
		(*PauseDequeueRequest)(nil),    // 24: worker.v1.PauseDequeueRequest
		(*PauseDequeueResponse)(nil),   // 25: worker.v1.PauseDequeueResponse
		(*ResumeDequeueRequest)(nil),   // 26: worker.v1.ResumeDequeueRequest
		(*ResumeDequeueResponse)(nil),  // 27: worker.v1.ResumeDequeueResponse
		(*ReplayDLQRequest)(nil),       // 28: worker.v1.ReplayDLQRequest
		(*ReplayDLQResponse)(nil),      // 29: worker.v1.ReplayDLQResponse
		(*ReplayDLQByIDRequest)(nil),   // 30: worker.v1.ReplayDLQByIDRequest
		(*ReplayDLQByIDResponse)(nil),  // 31: worker.v1.ReplayDLQByIDResponse
	}
)
...
var file_worker_v1_admin_proto_depIdxs = []int32{
	...
	12, // 5: worker.v1.ListSchedulesResponse.schedules:type_name -> worker.v1.ScheduleEntry
	12, // 6: worker.v1.CreateScheduleResponse.schedule:type_name -> worker.v1.ScheduleEntry
	12, // 7: worker.v1.PauseScheduleResponse.schedule:type_name -> worker.v1.ScheduleEntry
	21, // 8: worker.v1.ListDLQResponse.entries:type_name -> worker.v1.DLQEntry
	5,  // 9: worker.v1.AdminService.GetHealth:input_type -> worker.v1.GetHealthRequest
	0,  // 10: worker.v1.AdminService.GetOverview:input_type -> worker.v1.GetOverviewRequest
	8,  // 11: worker.v1.AdminService.ListQueues:input_type -> worker.v1.ListQueuesRequest
	10, // 12: worker.v1.AdminService.GetQueue:input_type -> worker.v1.GetQueueRequest
	13, // 13: worker.v1.AdminService.ListSchedules:input_type -> worker.v1.ListSchedulesRequest
	15, // 14: worker.v1.AdminService.CreateSchedule:input_type -> worker.v1.CreateScheduleRequest
	17, // 15: worker.v1.AdminService.DeleteSchedule:input_type -> worker.v1.DeleteScheduleRequest
	19, // 16: worker.v1.AdminService.PauseSchedule:input_type -> worker.v1.PauseScheduleRequest
	22, // 17: worker.v1.AdminService.ListDLQ:input_type -> worker.v1.ListDLQRequest
	24, // 18: worker.v1.AdminService.PauseDequeue:input_type -> worker.v1.PauseDequeueRequest
	26, // 19: worker.v1.AdminService.ResumeDequeue:input_type -> worker.v1.ResumeDequeueRequest
	28, // 20: worker.v1.AdminService.ReplayDLQ:input_type -> worker.v1.ReplayDLQRequest
	30, // 21: worker.v1.AdminService.ReplayDLQByID:input_type -> worker.v1.ReplayDLQByIDRequest
	6,  // 22: worker.v1.AdminService.GetHealth:output_type -> worker.v1.GetHealthResponse
	4,  // 23: worker.v1.AdminService.GetOverview:output_type -> worker.v1.GetOverviewResponse
	9,  // 24: worker.v1.AdminService.ListQueues:output_type -> worker.v1.ListQueuesResponse
	11, // 25: worker.v1.AdminService.GetQueue:output_type -> worker.v1.GetQueueResponse
	14, // 26: worker.v1.AdminService.ListSchedules:output_type -> worker.v1.ListSchedulesResponse
	16, // 27: worker.v1.AdminService.CreateSchedule:output_type -> worker.v1.CreateScheduleResponse
	18, // 28: worker.v1.AdminService.DeleteSchedule:output_type -> worker.v1.DeleteScheduleResponse
	20, // 29: worker.v1.AdminService.PauseSchedule:output_type -> worker.v1.PauseScheduleResponse
	23, // 30: worker.v1.AdminService.ListDLQ:output_type -> worker.v1.ListDLQResponse
	25, // 31: worker.v1.AdminService.PauseDequeue:output_type -> worker.v1.PauseDequeueResponse
	27, // 32: worker.v1.AdminService.ResumeDequeue:output_type -> worker.v1.ResumeDequeueResponse
	29, // 33: worker.v1.AdminService.ReplayDLQ:output_type -> worker.v1.ReplayDLQResponse
	31, // 34: worker.v1.AdminService.ReplayDLQByID:output_type -> worker.v1.ReplayDLQByIDResponse
